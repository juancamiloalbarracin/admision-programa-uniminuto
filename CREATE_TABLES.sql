-- Script SQL para crear las tablas necesarias para la funcionalidad de consulta de datos
-- Ejecutar este script en MySQL para crear las tablas necesarias

-- 1. Tabla para información personal
...
-- 2. Tabla para información académica
...
-- 3. Tabla para solicitudes radicadas
...
-- INSERT INTO solicitudes (user_email, numero_radicado, tipo_solicitud, asunto, descripcion) 
-- VALUES ('test@example.com', 'RAD-20250804-1234', 'Consulta General', 'Prueba de solicitud', 'Esta es una solicitud de prueba');

-- Verificar que las tablas se crearon correctamente
SHOW TABLES LIKE '%info_%';
SHOW TABLES LIKE '%solicitudes%';
